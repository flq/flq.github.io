...
namespace TVD.OLCM.POC
{
  /// <summary>
  /// Expression Visitor to inspect an expression tree: Courtesy of Matt Warren
  /// on his blog entry : LINQ: Building an IQueryable Provider - Part II (31.07.2007)
  ...
  public abstract class ExpressionVisitor
  {
    protected virtual Expression Visit(Expression exp)
    {
      ...
      switch (exp.NodeType)
      {
        ...
        default:
          throw new ArgumentException("Unhandled expression type", exp.NodeType.ToString());
      }
    }
    ...
    protected virtual MemberBinding VisitBinding(MemberBinding binding)
    {
      switch (binding.BindingType)
      {
        ...
        default:
          throw new ArgumentException("Unhandled binding type", binding.BindingType.ToString());
      }
    }
    ...
    protected virtual Expression VisitUnary(UnaryExpression u)
    {
      ...
      return operand != u.Operand ? 
        Expression.MakeUnary(u.NodeType, operand, u.Type, u.Method) : u;
    }
    ...
    protected virtual MemberListBinding VisitMemberListBinding(MemberListBinding binding)
    {
      ...
      return initializers != binding.Initializers ? 
        Expression.ListBind(binding.Member, initializers) : binding;
    }
    ...
    protected virtual Expression VisitLambda(LambdaExpression lambda)
    {
      ...
      return body != lambda.Body ? 
        Expression.Lambda(lambda.Type, body, lambda.Parameters) : lambda;
    }
    ...
    protected virtual NewExpression VisitNew(NewExpression nex)
    {
      ...
      if (args != nex.Arguments)
      {
        return nex.Members != null ? 
          Expression.New(nex.Constructor, args, nex.Members) : Expression.New(nex.Constructor, args);
      }
      return nex;
    }
