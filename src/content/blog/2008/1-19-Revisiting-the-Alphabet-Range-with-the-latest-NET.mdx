...
slug: revisiting-the-alphabet-range-with-the-latest-net
---
...
It has been quite some time since I did an update to the [.NET goodies](/posts/realfiction-goodies-net-stuff-you-may-like-to-use). In there there was an implementation to be able to iterate over the letters of the alphabet.
