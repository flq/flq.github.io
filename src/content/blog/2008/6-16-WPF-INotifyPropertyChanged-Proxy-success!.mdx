...
Remember the [Epic fail](/posts/wpf-inotifypropertychanged-proxy-epic-fail) that was building a simple class and a proxy on top to save on doing the PropertyChanged-mechanics?
