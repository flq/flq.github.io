...
slug: some-more-on-the-implicit-operator
---

Elaborating on my [past post](/posts/c-implicit-operator) on the implicit operator in C#, here some additional information to round this thing up.
...
You can find an example here with the [SingletonOf&lt;T&gt;](/posts/singletons-are-boring-hence-factor-out-the-concern). Further examples are
