...
<Info icon={false}>
_Update:_ There's [a new version][1] for 2025, written with all the glory that .NET9 provides at this point in time.
</Info>
...
<Gist id="369432" showHint />

[1]: /posts/a-http-file-server-in-60-lines-of-code