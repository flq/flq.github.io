...
<Math exp={'r_e = 6371km'} caption="Radius of Earth" />
<Math exp={'r_a = 6373km'} caption="Radius of upper boundary of the air layer we will consider" />
<Math exp={'\\rho_a = 1.225\\frac{kg}{m^3}'} caption="Density of air" />
<Math exp={'CV_a = 718\\frac{J}{kgK}'} caption="Specific heat of air" />
...
[1]: /posts/nmeasure-and-the-global-warming
