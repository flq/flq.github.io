...
topic: "fun-spin"
slug: funspins-no-attributes-no-vectors-a-tiny-workflow-and-more-squares
---

<TopicToc topicId="fun-spin" active="FunSpIns - No attributes, No vectors, A tiny Workflow and more squares" />
