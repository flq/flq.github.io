...
> So if you're a developer feeling pressured to adopt these tools — by your manager, your peers, or the general industry hysteria — trust your gut. 
> If these tools feel clunky, if they're slowing you down, if you're confused how other people can be so productive, you're not broken.

[This article][6] is again basically one data-point, but this person made the effort of estimating tasks and then
throwing a coin whether he'd do it with AI or not, and then compare the outcome with his estimate. Absolutely interesting stuff.

So where's the [_shovelware_](https://en.wikipedia.org/wiki/Shovelware)?
...
[6]: https://mikelovesrobots.substack.com/p/wheres-the-shovelware-why-ai-coding