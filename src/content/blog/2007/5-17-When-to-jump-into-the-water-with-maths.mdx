...
slug: when-to-jump-into-the-water-with-maths
---
...
<Math exp={'z = \\frac{v_2}{v_1}, r = \\frac{k_2}{k_1}'} centered />
...
<Math exp={'T_{total} = f(x) = \\frac{k_1}{v_1} x + \\frac{k_1}{v_1 z} \\sqrt{(1-x)^2+r^2}'} centered />
...
<Math exp={'x = \\frac{-b\\pm\\sqrt{b^2 - 4ac}}{2a}'} centered />
...
<Math exp={'x = 1 \\pm \\frac{z\\sqrt{r^2(1 - z^2)}}{z^2 - 1}'} centered />
