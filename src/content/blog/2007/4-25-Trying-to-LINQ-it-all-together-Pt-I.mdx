...
slug: trying-to-linq-it-all-together-pt-i
---
...
## Update from 29.04.07 - The following lines lead to wrong conclusions. For a better picture read the [next post](/posts/trying-to-linq-it-all-together-pt-i-epilogue)
