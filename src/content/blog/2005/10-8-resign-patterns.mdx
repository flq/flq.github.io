...
<Info>
*_Update October 2025_*

The original link I pointed to has been lost in time unfortunately. I have a vague recollection
that those patterns had been illustrated. Then, a couple of places on the Internet point to a website,
which is since also defunct (agcs.com).

I found a version [here](http://nishitalab.org/user/paulo/files/resign-patterns.txt), 
and I shall duplicate because at this point I'm afraid that such things can simply
get lost.
</Info>

# Resign Patterns

_Ailments of Unsuitable Project-Disoriented Software_
