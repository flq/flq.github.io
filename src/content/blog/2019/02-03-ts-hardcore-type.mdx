...
slug: typescript-type-shenanigans-2-specify-at-least-one-property
---
...
Exclude<T, U>
```
<figcaption>Exclude from T those types that are assignable to U</figcaption>
