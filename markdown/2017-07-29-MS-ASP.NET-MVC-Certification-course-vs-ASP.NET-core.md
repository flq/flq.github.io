...
- [Video 1 - Introduction](#video-1---introduction)
- [Video 2 - Models](#video-2---models)
- [Video 3- Controllers](#video-3--controllers)
- [Video 4- Views](#video-4--views)
- [Video 5 - Javascript, Page updates etc.](#video-5---javascript-page-updates-etc)
- [Video 6 - Web APIs.](#video-6---web-apis)
- [Deploying to Azure](#deploying-to-azure)
  - [Missing `Microsoft.EntityFrameworkCore.Design`](#missing-microsoftentityframeworkcoredesign)
  - [Connection string from _appsettings.json_ not found:](#connection-string-from-_appsettingsjson_-not-found)
